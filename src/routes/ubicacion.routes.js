...
router.get('/viaje/:viajeId/ultima', ubicacionController.obtenerUltimaUbicacion);
...
router.get('/viaje/:viajeId/usuario/:usuarioDNI', ubicacionController.obtenerUbicacionesUsuario);
